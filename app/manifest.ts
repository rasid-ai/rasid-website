...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    theme_color: '#060C0A',
    icons: [
      { src: '/logo/manifest-192.png', sizes: '192x192', type: 'image/png' },
      { src: '/logo/manifest-512.png', sizes: '512x512', type: 'image/png' },
      { src: '/logo/manifest-512.png', sizes: '512x512', type: 'image/png', purpose: 'maskable' },
    ],
  };
}
